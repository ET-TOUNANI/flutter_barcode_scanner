...
public class FlutterBarcodeScannerPlugin implements MethodCallHandler, ActivityResultListener,
        StreamHandler, FlutterPlugin, ActivityAware {
    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
        try {
            ...
            if (call.method.equals("scanBarcode")) {
                ...
                if (arguments.get("scanMode") != null) {
                    ...
                    if (mode == BarcodeCaptureActivity.SCAN_MODE_ENUM.DEFAULT.ordinal()) {
                        BarcodeCaptureActivity.SCAN_MODE =
                                BarcodeCaptureActivity.SCAN_MODE_ENUM.QR.ordinal();
                    } else {
            ...
            Log.e("FlutterBarcodeScanner", "onMethodCall: " + e.getLocalizedMessage());
        }
    }
    ...
    private void startBarcodeScannerActivityView(String buttonText, boolean isContinuousScan) {
        try {
            ...
            Log.e("FlutterBarcodeScanner", "startView: " + e.getLocalizedMessage());
        }
    }
    ...
    public void onAttachedToActivity(ActivityPluginBinding binding) {
        ...
        createPluginSetup(pluginBinding.getBinaryMessenger(),
                (Application) pluginBinding.getApplicationContext(), binding.getActivity(),
                binding);
    }
    ...
    private void createPluginSetup(final BinaryMessenger messenger,
            final Application applicationContext, final Activity activity,
